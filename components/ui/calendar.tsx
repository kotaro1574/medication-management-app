    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "size-7 border-none bg-transparent p-0 opacity-50 hover:opacity-100"
        ),
        ...
        day: cn(
          ...
          "size-9 p-0 text-[15px] font-normal aria-selected:opacity-100"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "hover:text-[#ffffff] hover:rounded-full hover:bg-[#FFCA0E] hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
